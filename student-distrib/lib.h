...
void clear_screen();
void do_backspace();
void putc_terminal(uint8_t c, int x, int y);
void putc_running_terminal(uint8_t c, int x, int y);
int32_t filecmp(const uint8_t* s1, const uint8_t* s2);
void putc_mouse(uint8_t c, int x, int y, int attribute);
void boot_shark();
